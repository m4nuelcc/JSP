...
<!-- 				AÑADIR SUBIDA DEL SUELDO EN LA CASILLA DE SUELDO -->
		...
		<h2>INCREMENTO SUELDO EMPLEADOS UTILIZANDO IF</h2>
...
<!-- 		UTILIZANDO LAS MISMA REGLA PERO CON CHOOSE -->


		</table>
		
		<h2>INCREMENTO SUELDO EMPLEADOS UTILIZANDO CHOOOSE</h2>
				...
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:when test="${empleado.sueldo<=35000}">
							
								<b style="color: green;">${empleado.sueldo+5000}</b> 
							
							</c:when>
							
							<c:when test="${empleado.sueldo>=40000 && empleado.sueldo<50000 }">
							
								<b style="color: blue;">${empleado.sueldo+2001}</b> 
							
							</c:when>
							
							<c:otherwise>
							
								<b style="color: red;">${empleado.sueldo}</b> 
